...
public interface PropertyRepository extends JpaRepository<Property, Long> {
    ...
    @Query("select p from Property p JOIN Location l on p.location=l.id JOIN Country c on p.country=c.id where l.locationName=:locationName or c.countryName=:locationName")//what is p here is a property class and what consists of variables like id ,consits of property name,location..etc
