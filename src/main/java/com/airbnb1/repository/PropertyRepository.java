...
public interface PropertyRepository extends JpaRepository<Property, Long> {
    ...
    @Query("select p from Property p JOIN Location l on p.location=l.id where l.locationName=:locationName")//what is p here is a property class and what consists of variables like id ,consits of property name,location..etc
